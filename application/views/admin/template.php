					...
					<ul class="nav navbar-nav">
						<li class="dropdown user user-menu">
							...
							<a href="#" class="dropdown-toggle" data-toggle="dropdown">
								<img style="float: none" src="<?php echo base_url('assets/dist/img/adm.jpg'); ?>" class="user-image" alt="User Image">
								<span class="hidden-xs"></span>
							</a>
							<ul class="dropdown-menu animated fadeInRight" style="    top: 37px;">
								<!-- User image -->
								<li class="user-header">
									<img src="<?php echo base_url('assets/dist/img/adm.jpg'); ?>" class="img-circle" alt="User Image">
...
<!--									</div>-->
		...
		<footer class="main-footer">
			...
			<strong>COPYRIGHT &copy; <?php echo date('Y'); ?> by Kelompok 4 UBSI Cengkareng</strong>
		</footer>
